...
class Struktur extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('board/pages/struktur/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('board/pages/struktur/create', $data);
    }
    ...
    public function editAnggota($id)
    {
        ...
        return view('board/pages/struktur/edit_anggota', $data);
    }
    ...
    public function editLevel($id)
    {
        ...
        return view('board/pages/struktur/edit_level', $data);
    }
    ...
    public function editJabatan($id)
    {
        ...
        return view('board/pages/struktur/edit_jabatan', $data);
    }
